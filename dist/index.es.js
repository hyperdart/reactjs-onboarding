...
function Caret(_ref2) {
  ...
  return style ? React.createElement('div', { style: style }) : null;
}
...
var Onboarding = function (_Component) {
  ...
  createClass(Onboarding, [{
    ...
    value: function render() {
      ...
      var activeChild = React.cloneElement(children[step], {
