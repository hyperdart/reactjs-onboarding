...
import { Typography, withStyles, Modal, MobileStepper, Button } from '@material-ui/core';
...
var ArrowCurved = (function (props) {
	...
	if (!startBox || !endBox) return React.createElement(React.Fragment, null);
		...
		React.createElement(
			...
			React.createElement(
				...
				{ id: "triangle", viewBox: "0 0 " + arrowSize + " " + arrowSize,
					...
					orient: "auto" },
				React.createElement("path", { d: "M 0 0 L " + arrowSize + " " + arrowSize / 2 + " L 0 " + arrowSize + " z", style: { fill: clr } })
			)
		),
								...
								value: function render() {
												...
												return React.createElement(
																...
																React.createElement(
																				'div',
																				null,
																				React.createElement(ArrowCurved, { color: 'white', startBox: msgBoxRect, endBox: targetRect }),
																				React.createElement(
																								'div',
...
var OnboardingItem$1 = withStyles(styles, { withTheme: true })(OnboardingItem);
	...
	createClass(OnboardingTag, [{
		...
		value: function componentDidMount() {
			if (this.tagRef.current) {
				this.tagItem = React.createElement(OnboardingItem$1, { elementID: this.tagRef.current, message: this.props.message });
          ...
          React.createElement(
            ...
            React.createElement(MobileStepper, {
              ...
              nextButton: React.createElement(
                ...
                activeStep == childCount - 1 ? React.createElement(
                  'p',
                  null,
                  'Done'
                ) : React.createElement(
              ...
              backButton: React.createElement(
                ...
                activeStep == 0 ? React.createElement('p', null) : React.createElement(
                  'p',
                  null,
                  'Back'
                )
...
var _Onboarding = withStyles(styles$1, { withTheme: true })(Onboarding);
...
export default src;
export { Onboarding$1 as Onboarding, OnboardingItem$2 as OnboardingItem, OnboardingTag$1 as OnboardingTag };
