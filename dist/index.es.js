  ...
  createClass(OnboardingItem, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        Fragment,
        null,
        !disableArrow && React.createElement(ArrowCurved, { color: 'white', width: 2, startBox: msgBoxRect, endBox: targetRect }),
        React.createElement(
          'div',
...
function OnboardingTag(_ref) {
  ...
  var tagItemRef = useRef(null);

  useEffect(function () {
    if (tagRef.current) {
      tagItemRef.current = React.createElement(OnboardingItem, { elementID: tagRef.current, message: message });
...
var Onboarding = function (_Component) {
  ...
  function Onboarding(props) {
    ...
    _this._getChildArray = function () {
      var filtered = React.Children.toArray(_this.props.children).filter(function (child) {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          showDots ? childArray.map(function (_, i) {
            return React.createElement('span', { key: i, style: S.dot(i === step), 'aria-hidden': 'true' });
          }) : React.createElement(
            'span',
            { style: S.stepLabel },
            step + 1,
...
export { Onboarding, OnboardingItem, OnboardingTag };
